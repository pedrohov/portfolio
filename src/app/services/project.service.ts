  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      tech_concepts: [
        "Apache Cordova",
        "Dados em JSON",
        "Controle Touchscreen/Mouse",
        "Ads com Chartboost e Admob",
        "Integração com API do Google Play",
    ...
    },
    {
      ...
      website:
        "https://github.com/pedrohov/Sistema-Web-de-Vendas-e-Atendimentos",
      content:
    ...
    },
    {
      ...
      description:
        "Aplicação para gerenciamento de lojas utilizando API RESTful e banco de dados não relacionais. Desenvolvido em Angular e empacotado para Windows e Ubuntu com a framework Electron.",
      tags: ["Angular", "RESTful API", "NeDB/MongoDB"],
      thumbnail: "./assets/images/vendasAngular-thumb.jpg",
      website: "",
      content:
        "Sistema de gerenciamento de lojas com o objetivo de simplificar a movimentação do caixa e os registros de estoques e clientes. Front end desenvolvido com Angular 7 e Angular Material, com REST api utilizando Express e Node para realizar persistência de dados em NeDB.",
      tech_concepts: [
        "Banco de dados não relacional (NeDB)",
        "Angular Routes",
        "Webdesign em HTML/CSS",
        "RESTful API com Express/Node",
      ],
      pictures: [
        "./assets/images/vendasAngular/vendasAngular1.jpg",
        "./assets/images/vendasAngular/vendasAngular2.jpg",
        "./assets/images/vendasAngular/vendasAngular3.jpg",
        "./assets/images/vendasAngular/vendasAngular4.jpg",
        "./assets/images/vendasAngular/vendasAngular5.jpg",
      ],
    },
  ];
